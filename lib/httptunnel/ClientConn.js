...
module.exports = class ClientConn extends require("stream").Duplex {
  ...
  constructor(urlEndPoint) {
    ...
    if (this.url.protocol === 'https:') {
      ...
      this.sendAgent = new https.Agent({maxSockets: 1, keepAlive: true, keepAliveMsecs: 10000});
      this.recvAgent = new https.Agent({maxSockets: 1, keepAlive: true, keepAliveMsecs: 10000});
    } else {
      this.doHttp = http;
